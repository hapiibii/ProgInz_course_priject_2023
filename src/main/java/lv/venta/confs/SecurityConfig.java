...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain (HttpSecurity http) throws Exception {
		...
		.requestMatchers("/Calendar-schedule/calendar-add").hasAnyAuthority("USER")
		.requestMatchers("/Calendar-schedule/remove-activity").hasAnyAuthority("USER")
		...
		.requestMatchers("/document-page/update-document/**").hasAnyAuthority("USER")
		.requestMatchers("/document").hasAnyAuthority("USER")
		.requestMatchers("/document/showAll").hasAnyAuthority("USER")
		.requestMatchers("/document/showAll/**").hasAnyAuthority("USER")
		.requestMatchers("/document/delete/**").hasAnyAuthority("USER")
		.requestMatchers("/document/update/**").hasAnyAuthority("USER")
		...
		.requestMatchers("/home-page/delete-news/**").hasAnyAuthority("USER")
		...
		.requestMatchers("/home-page/delete-document/**").hasAnyAuthority("USER")
		.requestMatchers("/submission").hasAnyAuthority("USER")
		.requestMatchers("/submission/showAll").hasAnyAuthority("USER")
		.requestMatchers("/submission/showAll/**").hasAnyAuthority("USER")
		.requestMatchers("/submission/delete/**").hasAnyAuthority("USER")
		.requestMatchers("/submission/update/**").hasAnyAuthority("USER")
		...
		.requestMatchers("/itftable-page/edit/**").hasAnyAuthority("USER")
		.requestMatchers("/itftable-page/delete/**").hasAnyAuthority("USER")
